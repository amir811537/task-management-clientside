                                ...
                                <div className="text-xl md:text-2xl font-bold text-gray-900 flex justify-between">
                                    ...
                                    <svg className="h-6 w-6 animate-ping-slow text-gray-500" viewBox="0 0 50 50" fill="none"
                                        ...
                                        <path
                                            ...
                                            stroke="currentColor" strokeOpacity="0.7" strokeWidth="4"
                                        ...
                                        <path
                                            ...
                                            stroke="currentColor" strokeOpacity="0.4" strokeWidth="4.5"
                                            strokeLinecap="round" strokeLinejoin="round"></path>
                                        <path
                    ...
                    <div className="flex flex-col justify-between h-full space-y-5">
                        ...
                        <div className="pt-2">
                            <a href="#" type="button"
                                ...
                                <svg className="inline-block h-6" viewBox="0 0 24 25" fill="none"
                                    xmlns="http://www.w3.org/2000/svg">
                                    <path d="M3 12.4999H21L14 19.4999M14 5.5L18 9.5" stroke="currentColor" strokeWidth="2"
                                        strokeLinecap="round" strokeLinejoin="round"></path>
                                </svg>
                            </a>
                        </div>
